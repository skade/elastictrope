...
require "elastictrope/meta-index"
require 'heliotrope/person'
require 'heliotrope/message'

include Heliotrope

NODE = ElasticSearch::Node::Embedded.new

class ElastictropeTest < ::Test::Unit::TestCase
  class MockMessage
    def initialize opts={}
      @@ids ||= 0
  ...
  def setup
    @metaindex = Elastictrope::MetaIndex.new
    @metaindex.wipe!
  end
  ...
  def test_message_threading_with_unknown_root
     m1 = MockMessage.new :msgid => "2", :refs => ["1"]
     docid1, threadid1 = @metaindex.add_message m1

     m2 = MockMessage.new :msgid => "3", :refs => ["1"]
     docid2, threadid2 = @metaindex.add_message m2
